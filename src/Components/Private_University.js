            ...
            <div className=' pb-5'>
              ...
              <form method='GET' encType='multipart/form-data'>
                ...
                <div className="d-flex flex-wrap justify-content-center my-5">
                  ...
                  {/* {
                    Searchuniversity.field || Searchuniversity.city ?
                      universitydata.map((element) => {
                        const picurl = 'http://localhost:4000/public/uploads/'
                        if (element.field.toLowerCase() === Searchuniversity.field.toLowerCase() && element.city.toLowerCase() === Searchuniversity.city.toLowerCase()) {
                          return (
                            <>
                  ...
                  {/* {
   setDisplayedUniversities ( universitydata
  .filter(element => !Searchuniversity.field || element.field.toLowerCase() === Searchuniversity.field.toLowerCase())
  .filter(element => !Searchuniversity.city || element.city.toLowerCase() === Searchuniversity.city.toLowerCase())
