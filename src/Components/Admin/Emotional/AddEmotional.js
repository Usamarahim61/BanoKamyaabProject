...
function AddEmotional() {
 ...
 const navigate = useNavigate();
    ...
    const handleSubmit = async (e) => {
      e.preventDefault();
      try {
        const response = await axios.post("/AddEmotional", {
          question
            ...
            <div className=" mt-5 ">
                <div className="Head">
                    <div className="overlay">
                        <h1 className="fw-bold fs-1 text-uppercase">Add Emotional Intellegence Questions</h1>
                    </div>
                </div>
            </div>
