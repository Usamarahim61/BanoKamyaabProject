      ...
      <div className=" mt-5 ">
        <div className="Head">
          <div className="overlay">
            <h1 className="fw-bold fs-1 text-uppercase">Private Universities</h1>
          </div>
        </div>
      </div>
          ...
          <form method="POST" onSubmit={PostData} encType="multipart/form-data">
            <div className="p-3">
              ...
              <div className="row mt-3">
                ...
                <div className="col-md-6 mt-3"><label className="labels">Type</label><input name="type" id="type" type="text" className="form-control" placeholder="Tye" value={University.type} onChange={handleInput} required/></div>
